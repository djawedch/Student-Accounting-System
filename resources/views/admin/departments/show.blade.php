            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-2xl font-semibold text-gray-900">Department Information</h2>
                        <div>
                        ...
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-lg text-gray-900">
                                    <a href="{{ route('admin.universities.show', $department->university) }}"
                    ...
                    <div class="mt-8">
                        <h3 class="text-xl font-semibold text-gray-900 mb-4">Users in this Department</h3>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($department->users as $user)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ $user->first_name }} {{ $user->last_name }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ $user->email }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ ucfirst($user->role) }}</td>
                    ...
                    <div class="mt-8">
                        <h3 class="text-xl font-semibold text-gray-900 mb-4">Fees in this Department</h3>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($department->fees as $fee)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ $fee->id }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ $fee->name }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ number_format($fee->amount, 2) }} DZD</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ $fee->academic_year }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-gray-900">{{ $fee->description ?? '—' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
