...
class PaymentFilter
{
    ...
    public function apply(Builder $query): Builder
    {
        return $query
            ...
            ->when($this->request->filled('date_from'), fn($q) =>
                $q->whereDate('payment_date', '>=', $this->request->date_from)
            )
            ->when($this->request->filled('date_to'), fn($q) =>
